...
@onready var fps_worst_label: Label = %FPSWorst
@onready var frame_time: Label = %FrameTime
@onready var frame_number: Label = %FrameNumber

@onready var frame_history_avg_header: Label = %AvgHeader
@onready var frame_history_min_header: Label = %MinHeader
@onready var frame_history_max_header: Label = %MaxHeader
@onready var frame_history_last_header: Label = %LastHeader
@onready var frame_history_total_header: Label = %TotalHeader
...
@onready var frame_history_cpu_header: Label = %CPUHeader
@onready var frame_history_cpu_avg: Label = %CPUAvg
@onready var frame_history_cpu_min: Label = %CPUMin
@onready var frame_history_cpu_max: Label = %CPUMax
@onready var frame_history_cpu_last: Label = %CPULast
@onready var frame_history_gpu_header: Label = %GPUHeader
@onready var frame_history_gpu_avg: Label = %GPUAvg
@onready var frame_history_gpu_min: Label = %GPUMin
@onready var frame_history_gpu_max: Label = %GPUMax
@onready var frame_history_gpu_last: Label = %GPULast

@onready var fps_graph: HBoxContainer = %FPSGraph
@onready var total_graph: HBoxContainer = %TotalGraph
@onready var cpu_graph: HBoxContainer = %CPUGraph
@onready var gpu_graph: HBoxContainer = %GPUGraph
...
func _process(_delta: float) -> void:
	if visible:
		...
		if frames_per_second < fps_worst:
			fps_worst = frames_per_second

		fps.text = str(floor(frames_per_second)) + " FPS"
		fps_worst_label.text = str(floor(fps_worst)) + " FPS"
